...
export default defineConfig({
  ...
  server: {
    ...
    headers: {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https://new-tech-be.onrender.com; connect-src 'self' https://localhost:5000 wss://localhost:5000 https://new-tech-be.onrender.com; object-src 'none'; base-uri 'self';",
    },
  },
})